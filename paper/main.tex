...
\usepackage{url}
\usepackage{booktabs}
\title{Causal Robot Data Selection: ICLR Main-Conference Gate Archive}
\author{Anonymous Authors}
\begin{document}
\maketitle
\begin{abstract}
This document is not an ICLR main-conference submission. It is the v3 main-conference gate for a generated robotics draft about robot data selection. The original research bet was: Select training data that separates causal mechanisms rather than balances labels. After a stricter hostile review, the honest terminal decision is \textbf{KILL/ARCHIVE}. Submission-hardening version: v3.
\end{abstract}
...
\item Adaptive Client Selection in Resource Constrained Federated Learning Systems: A Deep Reinforcement Learning Approach (2021)
\item Images Speak Louder than Words: Understanding and Mitigating Bias in Vision-Language Model from a Causal Mediation Perspective (2024)
\item SmolVLA: A Vision-Language-Action Model for Affordable and Efficient Robotics (2025)
\end{itemize}
